...
API_ID = int(environ.get('API_ID', '25837284'))
API_HASH = environ.get('API_HASH', '9117c431df63ec98f8822ccc753ab497')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002327157811'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5150410516').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002457043397').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002288205625') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://demodikshi:pbfLKXXrzIKQ8JoZ@dikshidemo.axujh.mongodb.net/?retryWrites=true&w=majority&appName=dikshidemo")
DATABASE_NAME = environ.get('DATABASE_NAME', "demodikshi")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'demodikshi')
